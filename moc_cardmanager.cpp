...
const QMetaObject CardManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CardManager.data,
      qt_meta_data_CardManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *CardManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CardManager.stringdata0))
        return static_cast<void*>(const_cast< CardManager*>(this));
